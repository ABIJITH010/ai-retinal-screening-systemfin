...
async def create_report(
    ...
    # Run AI prediction in a threadpool to avoid blocking the event loop
    try:
        from app.services.ai_service import predict_dr_stage
        import anyio
        
        prediction, confidence, heatmap_path = await anyio.to_thread.run_sync(
            predict_dr_stage, image_path
        )
    except Exception as e:
        raise HTTPException(
